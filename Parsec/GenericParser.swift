...
public final class GenericParser <StreamType: Stream, UserState, Result> : Parsec
{
    ...
    let parse: (_ state: ParserState <StreamType.Iterator, UserState>) -> Consumed <StreamType, UserState, Result>
            ...
            repeat {
                ...
                case .none(let reply):
                    ...
                    case .ok:
                        ...
                        let failureMsg = LocalizedString(
...
{
    /// Indicates that the parsing was successful. It contains a `Result` type,
