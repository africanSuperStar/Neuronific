...
class CharacterParsersTests : XCTestCase
{
    func testOneOf()
    {
        ...
        testStringParserSuccess(vowel, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(vowel, inputs: notMatching)
        {
            input, result in
    ...
    func testOneOfInterval()
    {
        ...
        testStringParserSuccess(interval, inputs: matching)
        {
            input, result in
    ...
    func testNoneOf()
    {
        ...
        testStringParserSuccess(consonant, inputs: matching)
        {
            input, result in
    ...
    func testSpaces()
    {
        ...
        testStringParserSuccess(skipSpaces, inputs: matching)
        {
            input, result in
    ...
    func testUnicodeSpace()
    {
        ...
        testStringParserSuccess(space, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(space, inputs: notMatching)
        {
            input, result in
    ...
    func testNewLine()
    {
        ...
        testStringParserSuccess(newLine, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(newLine, inputs: notMatching)
        {
            input, result in
    ...
    func testEndOfLine()
    {
        ...
        testStringParserSuccess(endOfLine, inputs: matching)
        {
            input, result in
    ...
    func testTab()
    {
        ...
        testStringParserSuccess(tab, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(tab, inputs: notMatching)
        {
            input, result in
    ...
    func testUppercase()
    {
        ...
        testStringParserSuccess(uppercase, inputs: matching)
        {
            input, result in
    ...
    func testLowercase()
    {
        ...
        testStringParserSuccess(lowercase, inputs: matching)
        {
            input, result in
    ...
    func testAlphaNumeric()
    {
        ...
        testStringParserSuccess(alphaNum, inputs: matching)
        {
            input, result in
    ...
    func testLetter()
    {
        ...
        testStringParserSuccess(letter, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(letter, inputs: notMatching)
        {
            input, result in
    ...
    func testSymbol()
    {
        ...
        testStringParserSuccess(symbol, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(symbol, inputs: notMatching)
        {
            input, result in
    ...
    func testDigit()
    {
        ...
        testStringParserSuccess(digit, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(digit, inputs: notMatching)
        {
            input, result in
    ...
    func testDecimalDigit()
    {
        ...
        testStringParserSuccess(hexDigit, inputs: matching)
        {
            input, result in
    ...
    func testHexadecimalDigit()
    {
        ...
        let shouldFailMessage = "GenericParser.hexadecimalDigit should fail."
    ...
    func testOctalDigit()
    {
        ...
        testStringParserSuccess(octDigit, inputs: matching)
        {
            input, result in
    ...
    func testString()
    {
        ...
        testStringParserSuccess(string1, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(string1, inputs: notMatching)
        {
            input, result in
