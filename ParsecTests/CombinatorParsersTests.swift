...
class CombinatorParsersTests : XCTestCase
{
    func testChoice()
    {
        ...
        testStringParserSuccess(choice, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(choice, inputs: notMatching)
        {
            input, result in
    ...
    func testOtherwise()
    {
        ...
        testStringParserFailure(string, inputs: notMatching)
        {
            input, result in
    ...
    func testMany1()
    {
        ...
        testStringParserSuccess(manyString, inputs: matching)
        {
            input, result in
    ...
    func testCount()
    {
        ...
        testStringParserSuccess(letters, inputs: matching)
        {
            input, result in
        ...
        testStringParserSuccess(asdf, inputs: matchingAsdf)
        {
            input, result in
    ...
    func testChainRight()
    {
        ...
        testStringParserSuccess(exp, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(exp, inputs: notMatching)
        {
            input, result in
    ...
    func testChainLeft()
    {
        ...
        testStringParserSuccess(add, inputs: matchingAdd)
        {
            input, result in
        ...
        testStringParserSuccess(mul, inputs: matchingMul)
        {
            input, result in
        ...
        testStringParserFailure(mul, inputs: notMatching)
        {
            input, result in
    ...
    func testChainLeft1()
    {
        ...
        testStringParserFailure(mulOp, inputs: notMatching)
        {
            input, result in
    ...
    func testNoOccurence()
    {
        ...
        testStringParserSuccess(keyworkLet, inputs: matching)
        {
            input, result in
    ...
    func testManyTill()
    {
        ...
        testStringParserSuccess(comment, inputs: matching)
        {
            inputStr, result in
        ...
        testStringParserFailure(comment, inputs: notMatching)
        {
            input, result in
    ...
    func testRecursive()
    {
        ...
        testStringParserSuccess(expression, inputs: matching)
        {
            input, result in
    ...
    func testEof()
    {
        ...
        testStringParserFailure(eof, inputs: notMatching)
        {
            input, result in
