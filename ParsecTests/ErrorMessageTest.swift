...
class ErrorMessageTests : XCTestCase
{
    func testCharacterError()
    {
        ...
        errorMessageTest(vowel, input: "z")
        {
            actual in
    ...
    func testStringError()
    {
        ...
        errorMessageTest(allo, input: "allz")
        {
            actual in
    ...
    func testEofError()
    {
        ...
        errorMessageTest(allo, input: "all")
        {
            actual in
    ...
    func testChoiceError()
    {
        ...
        errorMessageTest(hellos, input: "z")
        {
            actual in
        ...
        errorMessageTest(hellos, input: "all")
        {
            actual in
    ...
    func testPositionError()
    {
        ...
        errorMessageTest(parser, input: "\tall")
        {
            actual in
    ...
    func testLabelError()
    {
        ...
        errorMessageTest(newline, input: "z")
        {
            actual in
    ...
    func testMultiLabelError()
    {
        ...
        errorMessageTest(charA, input: "z")
        {
            actual in
    ...
    func testUnknownError()
    {
        ...
        errorMessageTest(empty, input: "z")
        {
            actual in
