...
class GenericParserTests : XCTestCase
{
    func testMap()
    {
        ...
        testParserSuccess(mappedParser)
        {
            input, result in
        ...
        testParserSuccess(functorParser)
        {
            input, result in
    ...
    func testAlternative()
    {
        ...
        testStringParserSuccess(alt1, inputs: ["adsf"])
        {
            input, result in
        ...
        testStringParserSuccess(alt2, inputs: matching)
        {
            input, result in
    ...
    func testAtempt()
    {
        ...
        testStringParserSuccess(attempt, inputs: matching)
        {
            input, result in
    ...
    func testLookAhead()
    {
        ...
        testStringParserSuccess(lookAhead, inputs: matching)
        {
            input, result in
    ...
    func testEmpty()
    {
        ...
        testStringParserFailure(empty, inputs: [""])
        {
            input, result in
    ...
    {
        let updateUserState = GenericParser <String, Int, Character>.updateUserState(curriedPlus(1))
        
        let countLetters = GenericParser <String, Int, Character>.letter <* updateUserState
