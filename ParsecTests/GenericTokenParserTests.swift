...
class GenericTokenParserTests : XCTestCase
{
    ...
    func testNatural()
    {
        ...
        testStringParserSuccess(natural, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(natural, inputs: notMatching)
        {
            input, result in
    ...
    func testInteger()
    {
        ...
        testStringParserSuccess(integer, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(integer, inputs: notMatching)
        {
            input, result in
    ...
    func testFloat()
    {
        ...
        testStringParserSuccess(float, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(float, inputs: notMatching)
        {
            input, result in
    ...
    func testNumber()
    {
        ...
        testStringParserSuccess(number, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(number, inputs: notMatching)
        {
            input, result in
    ...
    func testDecimal()
    {
        ...
        testStringParserSuccess(decimal, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(decimal, inputs: notMatching)
        {
            input, result in
    ...
    func testOctal()
    {
        ...
        testStringParserSuccess(octal, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(octal, inputs: notMatching)
        {
            input, result in
    ...
    func testSymbol()
    {
        ...
        {
            testStringParserSuccess(parser, inputs: [input])
            {
                input, result in
    ...
    func testWhiteSpace()
    {
        ...
        {
            testStringParserFailure(parser, inputs: input)
            {
                input, result in
    ...
    func testPunctuations()
    {
        ...
        {
            testStringParserSuccess(parser, inputs: [match])
            {
                input, result in
    ...
    func testBracketsParser(
        ...
        testStringParserSuccess(brackets, inputs: matching)
        {
            input, result in
    ...
    func testPunctuationSeparated(
        ...
        testStringParserSuccess(sepBy, inputs: matching)
        {
            input, result in
        ...
        testStringParserFailure(sepBy, inputs: notMatching)
        {
            input, result in
